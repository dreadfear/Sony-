...
lang['en'] = {
	'name': '',
	'searchResultName': '<strong> O - Ngon store(s)</strong>',
	'phone': 'Phone',
	'address': 'Address',
	'zoom': 'Zoom',
	'direction': 'Direction',
...
lang['vi'] = {
	'name': '',
	'searchResultName': '<strong> cửa hàng O - Ngon </strong>',
	'phone': 'Điện thoại',
	'address': 'Địa chỉ',
	'zoom': 'Phóng to',
					...
					success: function (msg) {
						...
						if (results.length > 0) {
							...
							jQuery.each(results, function (k, v) {
								...
								if (number > 9) {
									$("<li id='l_" + marker['__gm_id'] + "' class='clinic_list double-digit'  data-location=" + v.getAttribute("des") + "/>")
										.html("<p class='name'>" + v.getAttribute("name") + "<p><p class='address'><span class='mdi mdi-map-marker'></span>" + v.getAttribute("address") + "</p><p class='phone'> <span class='mdi mdi-phone'></span>" + v.getAttribute("phone") + "</p><p class='email'> <span class='mdi mdi-web'></span>" + v.getAttribute("website")  + "</p>")
										.click(function () {
									...
									$("<li id='l_" + marker['__gm_id'] + "' class='clinic_list'  data-location=" + v.getAttribute("des") + "/>")
										.html("<p class='name'>" + v.getAttribute("name") + "<p><p class='address'><span class='mdi mdi-map-marker'></span>" + v.getAttribute("address") + "</p><p class='phone'> <span class='mdi mdi-phone'></span>" + v.getAttribute("phone") + "</p><p class='email'> <span class='mdi mdi-web'></span>" +  v.getAttribute("website")  + "</p>")
										.click(function () {
											//displayPoint(marker, i);
											infowindow.setContent(info_window_string);
							...
							$('.clinic_list').click(function () {
								...
								$('#list .clinic_list').removeClass('active');
								let href = $('#list .clinic_list').attr("data-location");
								$('#location-iframe').attr("src", href)
