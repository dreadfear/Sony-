                            ...
                            jQuery.each(results, function(k, v) {
                                ...
                                if (number > 9) {
                                    $("<li id='l_" + marker['__gm_id'] + "' class='clinic_list double-digit' />").attr('data-map', v.getAttribute('des'))
                                        .html('<div class="icon"><img src="/Data/Sites/1/skins/default/img/map-marker.png"></div>' + '<address><p class="name">' + v.getAttribute('name') + '</p><p>' + v.getAttribute('address') + '</p><p>Tel: ' + v.getAttribute('phone') + '</p><p>Fax: ' + v.getAttribute('fax') + "</p><p><a href='" + v.getAttribute('website') + "'>" + v.getAttribute('website') + "</a></p></address>" + "<div class='link'>" + "<a class='view-map' href='#'>Xem bản đồ</a>" + "<a class='view-web' href='" + v.getAttribute('website') + "'>Website" + "</a></div>" + "<div id=d_" + number + " class='distance hidden'><span id='disval' attr-dist='" + distancenode + "' class='value'>" + distancenode + "</span> <span class='units'></span> <span class='time2'></span></div></div><div class='products'>" + ctype + "</div>")
                                        .click(function() {
