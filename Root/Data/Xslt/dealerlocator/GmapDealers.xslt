		...
		<div id="super-store-finder">
			<div id="main_content">
				<div id="clinic-finder" class="relative">
							...
							<div class="list-wrapper" style="z-index: 2;">
								<div class="filter-map">
									...
									<div class="field form_desc form-group hidden">
										<label class='hidden-label' for="ddlCountry" >
									...
									<div class="field form_desc form-group">
										<label class='hidden-label' for="ddlProvince"
									...
									<div class="field form_desc form-group">
										<label class='hidden-label' for="ddlDistrict"
													style="margin-bottom: 5px;">
					...
					<div id="map">
						<iframe title="My Daily Marathon Tracker" src="" frameborder="1" id='map-iframe'
